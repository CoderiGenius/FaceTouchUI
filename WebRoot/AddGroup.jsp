    ...
    <div class="sidebar-nav nav-collapse collapse">
      ...
      <div class="widget widget-padding span12">
            <div class="widget-header">
              <i class="icon-list-alt"></i><h5>添加小组</h5>
              ...
              <div class="widget-forms clearfix">
                <form class="form-horizontal" action = "${path}Servlet/IndexServlet">
                  <div class="control-group">
                    <label class="control-label">添加小组</label>
                    <div class="controls">
                     <input type="hidden" name="action" value="addGroup">
                     <h5>${addGroupStatus }</h5>
                     <input class="span7" type="text" placeholder="请输入新小组名称" name="groupName">
                      <button class="btn btn-primary" onclick="this.form.submit()" type="submit">添加小组</button>
                    </div>
                  </div>
