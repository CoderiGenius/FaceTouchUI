          ...
          <div class="accordion-group">
            ...
            <div id="collapse1" class="accordion-body collapse">
              <div class="accordion-inner">
                <a class="accordion-toggle" href="GroupManagement.jsp"><i class="icon-star"></i> Group management</a>
                <a class="accordion-toggle" href="forms.html"><i class="icon-list-alt"></i> unnamed</a>
                <a class="accordion-toggle" href="tables.html"><i class="icon-table"></i> unnamed</a>
